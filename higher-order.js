...
//Code Here
let myStrongest = monstersInYourPocket.filter(function(val,i,array){
  return val["CP"]>200;
})
...
let bobsTotal = purchases.filter(
   (obj) => { return obj.owner == 'Bob'; }).reduce( (sum,cur) => sum + cur.price, 0)
